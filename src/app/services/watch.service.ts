...
export class WatchService {
  ...
  constructor(private http: Http, private standingsService: StandingsService) {}
    ...
    if (environment.production) {
      setInterval(() => {
        this._sessionObservable().subscribe(session => {
          ...
          if (
            this._sessionData &&
            this._sessionData.session !== session.session
          ) {
    ...
    return Observable.create(observer => {
      setInterval(() => {
        ...
        if (
          ...
          this._sessionData.session === "INVALID"
        ) {
          return observer.next({
            session_info: null,
            standings: [],
...
const sampleStandingsData = [
  ...
  {
    position: 3,
    driverName: "Mattia Salva",
    bestLapTime: -1.0,
    pitstops: 0,
    pitting: true,
    lastLapTime: -1.0,
    vehicleName: "16LM Shattered Windshield Racing",
    timeBehindNext: 0.0,
    timeBehindLeader: 0.0,
    lapsBehindLeader: 1,
    lapsBehindNext: 1,
    ...
    lastSectorTime2: -1.0,
    focus: false,
    carClass: "Disruptive Tech Racing",
    slotID: 1,
    carStatus: "FINISHED",
    lapsCompleted: 1,
    hasFocus: false,
  ...
  {
    position: 4,
    driverName: "Mattia Sblva",
    bestLapTime: -1.0,
    pitstops: 0,
    pitting: false,
    lastLapTime: -1.0,
    vehicleName: "Mattia Silva #47",
    timeBehindNext: 0.0,
    timeBehindLeader: 0.0,
    lapsBehindLeader: 1,
    lapsBehindNext: 1,
  ...
  {
    position: 5,
    driverName: "Mattia Sclva",
    bestLapTime: -1.0,
    pitstops: 0,
    pitting: false,
    lastLapTime: -1.0,
    vehicleName: "Mattia Silva #47",
    timeBehindNext: 185.4,
    timeBehindLeader: 0.0,
    lapsBehindLeader: 1,
    lapsBehindNext: 0,
    currentSectorTime1: -1.0,
